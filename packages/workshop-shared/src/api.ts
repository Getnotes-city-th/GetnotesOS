 ...
 */
export const DEFAULT_SITE_NAME = "GetnotesOS";
...
export type AdminSettingsView = {
  ...
  siteName: string;
  /** Custom deployment logo, or undefined to use the default GetnotesOS mark. */
...
export interface AdminApi {
   ...
   * image, or undefined after reset. Pass null to restore the default GetnotesOS mark. The
