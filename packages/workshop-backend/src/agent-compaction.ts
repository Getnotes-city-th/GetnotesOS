...
// Pi clamps each request's output against its estimated prompt, so compaction only needs to bound
// the prompt itself rather than guessing whether a provider publishes combined or separate limits.
